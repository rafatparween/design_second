export const Disclaimer = () => {
    return <>
        <div class="max-w-7xl mx-auto p-8 space-y-6 bg-gray-100 text-gray-800">
            ...
            <p class="text-lg">
                The information provided by hewlettprintersolution (“Company”, “we”, “our”, “us”) on
                <u> hewlettprintersolution</u> is for general informational purposes only.
            ...
            <h2 class="text-2xl font-semibold text-gray-900">External Links Disclaimer</h2>
            <p class="text-lg">
                The Site may contain (or you may be sent through the Site) links to other websites or content belonging to or originating from third parties or links to websites and features.
            ...
            <h2 class="text-2xl font-semibold text-gray-900">Professional Disclaimer</h2>
            <p class="text-lg">
            ...
            <p class="text-lg">
                Content published on <a href="https://www.hewlettprintersolution.com" class="text-blue-500 hover:underline">www.hewlettprintersolution.com</a> is intended to be used and must be used for informational purposes only.
            ...
            <h2 class="text-2xl font-semibold text-gray-900">Testimonials Disclaimer</h2>
            <p class="text-lg">
            ...
            <p class="text-lg">
                While we have made every attempt to ensure that the information contained in this site has been obtained from reliable sources, hewlettprintersolution is not responsible for any errors or omissions or for the results obtained from the use of this information.
            ...
            <p class="text-lg">
                In no event will hewlettprintersolution, its related partnerships or corporations, or the partners, agents, or employees thereof be liable to you or anyone else for any decision made or action taken in reliance on the information in this Site
            ...
            <p class="text-lg">
                This Site may include content from guest contributors, and any views or opinions expressed in such posts are personal and do not represent those of hewlettprintersolution or any of its staff or affiliates unless explicitly stated.
            </p>

            <h2 class="text-2xl font-semibold text-gray-900">Logos and Trademarks Disclaimer</h2>
            <p class="text-lg">
                All logos and trademarks of third parties referenced on <a href="https://www.hewlettprintersolution.com" class="text-blue-500 hover:underline">www.hewlettprintersolution.com</a> are the trademarks and logos of their respective owners.
                Any inclusion of such trademarks or logos does not imply or constitute any approval, endorsement, or sponsorship of hewlettprintersolution by such owners.
            </p>
        </div>
    </>
}
