export const Disclaimer = () => {
    return <>
        <div class="max-w-7xl mx-auto p-8 space-y-6 bg-gray-100 text-gray-800">
            ...
            <p class="text-lg">
                The information provided by Micro Sonic Repair (“Company”, “we”, “our”, “us”) on
                <u> Micro Sonic Repair</u> is for general informational purposes only.
            ...
            <p class="text-lg">
                Content published on <a href="https://www.microsonicrepair.com" class="text-blue-500 hover:underline">www.microsonicrepair.com</a> is intended to be used and must be used for informational purposes only.
            ...
            <p class="text-lg">
                While we have made every attempt to ensure that the information contained in this site has been obtained from reliable sources,  Micro Sonic Repairis not responsible for any errors or omissions or for the results obtained from the use of this information.
            ...
            <p class="text-lg">
                In no event will Micro Sonic Repair, its related partnerships or corporations, or the partners, agents, or employees thereof be liable to you or anyone else for any decision made or action taken in reliance on the information in this Site
            ...
            <p class="text-lg">
                This Site may include content from guest contributors, and any views or opinions expressed in such posts are personal and do not represent those of Micro Sonic Repair or any of its staff or affiliates unless explicitly stated.
            </p>

            <h2 class="text-2xl font-semibold text-gray-900">Logos and Trademarks Disclaimer</h2>
            <p class="text-lg">
                All logos and trademarks of third parties referenced on <a href="https://www.microsonicrepairn.com" class="text-blue-500 hover:underline">www.microsonicrepair.com</a> are the trademarks and logos of their respective owners.
                Any inclusion of such trademarks or logos does not imply or constitute any approval, endorsement, or sponsorship of Micro Sonic Repair by such owners.
            </p>
        </div>
    </>
}
