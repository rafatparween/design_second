export const PrivacyPolicy = () => {
    return <>
        <div class="max-w-7xl mx-auto p-8 space-y-8 bg-gray-100 text-gray-800">
            ...
            <section>
                <h2 class="text-2xl font-semibold text-gray-900">What Personal Data We Collect & Why</h2>
                <p class="text-lg">
            ...
            <section>
                <h2 class="text-2xl font-semibold text-gray-900">We Value Your Personal Information</h2>
                <p class="text-lg">
